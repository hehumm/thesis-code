...
def generate_metrics():
    metrics_dir = '/home/henri/Code/thesis-code/metrics'
    ...
    for site in shared_utility.sites:
        values = data[site]
        measured_data = values['actual']['target'][-(final_shared.configuration.get('prediction_length')):]
        metrics_data = {
            "Model": ["Theta", "ETS", "AutoARIMA", "Chronos", "SARIMAX", "LSTM"],
            "MAPE": [
                mean_absolute_percentage_error(measured_data, values['Theta']['mean']),
                mean_absolute_percentage_error(measured_data, values['ETS']['mean']),
            ...
            "MAE": [
                ...
                mean_absolute_error(measured_data, values['ETS']['mean']),
            ...
            "RMSE": [
                ...
                root_mean_squared_error(measured_data, values['ETS']['mean']),
