...
def calculate_metrics_for_site(site_id):
    ...
    results_autoarima_path = f'/home/henri/documents/thesis/experiments_results/wape/models/others/separate_exog/{site_id}/predictions_2.csv'
    ...
    results_chronos_path = f'/home/henri/documents/thesis/experiments_results/wape/models/chronos/separate_exog/{site_id}/predictions_1.csv'
    ...
    metrics_df.loc[1] = {'site': site_id, 'model': 'SARIMAX Halving Random Search', 'mae': mae_sarimax_hr, 'rmse': rmse_sarimax_hr, 'wape': wape_sarimax_hr}
    metrics_df.loc[2] = {'site': site_id, 'model': 'AutoARIMA', 'mae': mae_autoarima, 'rmse': rmse_autoarima, 'wape': wape_autoarima}
    metrics_df.loc[3] = {'site': site_id, 'model': 'Chronos', 'mae': mae_chronos, 'rmse': rmse_chronos, 'wape': wape_chronos}
